...
i = sys.argv[1]
dataslice = polars.read_parquet(calculation_spam_dir.joinpath(f"scaf10_slice_{i}.parquet"))
...
res.write_parquet(calculation_spam_dir.joinpath(f"rescored_scaf10_slice_{i}.parquet"))